...
\section{EDUCATION}
    \textbf{University of California, Berkeley}, Berkeley, CA \hfill Expected 2020\\
...
% \end{itemize}
\hspace{0.2em}\hangpara{3em}{1} Stat 232: Experimental Design with Sam Pimentel \hfill Fall 2017\\
\hspace{0.2em}\hangpara{3em}{1} Stat 159/259: Reproducible and Collaborative Data Science with Fernando Perez \hfill Fall 2018
...
% \section{SKILLS}
% R, Python, Machine Learning, Experimental Design, Program Evaluation  % SQL, Scala, Spark, MATLAB, Java
